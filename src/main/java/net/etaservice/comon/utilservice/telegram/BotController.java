...
public class BotController {
    ...
    public void handlerAppList(BotNotificationService botNotificationService, Long chatId) throws GeneralSecurityException, IOException {
    ...
    public void addNote(BotNotificationService botNotificationService, Long chatId){
    ...
    public void submitSpending(BotNotificationService botNotificationService, Long chatId) throws GeneralSecurityException, IOException {
    ...
    public void cancelSpending(BotNotificationService botNotificationService, Long chatId){
...
private String buildStatisticFinancial(Map<String, String> data) {
    ...
    messageBuilder.append("| Current balances  |    ").append(data.get("E13")).append("\n");
    messageBuilder.append("| Balances after get paid  |    ").append(data.get("E16")).append("\n");
    ...
    @SneakyThrows
    public boolean handlerProcess(List<Update> updates, String value, BotNotificationService botNotificationService, String chatId) {
    ...
    private String buildTextForSpendingProcess(List<Object> listData){
        ...
        if (listData.size() > 3){
            stringBuilder.append(" được dùng để ").append("<b>").append(listDataSheet.get(3).toString().toLowerCase(Locale.ROOT)).append("</b>");
        }
        if (listData.size() > 5){
